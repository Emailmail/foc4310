...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, ICM42688_SCL_Pin|ICM42688_SDA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ICM42688_SCL_Pin ICM42688_SDA_Pin */
  GPIO_InitStruct.Pin = ICM42688_SCL_Pin|ICM42688_SDA_Pin;
